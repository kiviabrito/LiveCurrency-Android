package com.example.livecurrency.main
...
import com.example.livecurrency.utility.CurrencyAdapter
import com.example.livecurrency.utility.OnItemClickListener
...
class SelectionFragment : Fragment(), OnItemClickListener {
  ...
  private fun searchBarFilter(menu: Menu, inflater: MenuInflater) {
    ...
    inputListener(searchView)
  }

  private fun inputListener(searchView: SearchView) {
